/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3d3a9081b4e329b86d06797b8ca77814)
...
declare namespace Cloudflare {
	...
	interface Env {
		SMART_HOME_KV: KVNamespace;
		LINE_CHANNEL_ACCESS_TOKEN: string;
		LINE_CHANNEL_SECRET: string;
		SWITCHBOT_TOKEN: string;
		SWITCHBOT_SECRET: string;
		ALLOWED_LINE_USER_IDS: string;
		SWITCHBOT_BOT_DEVICE_ID: string;
		SWITCHBOT_LIVING_ROOM_AC_DEVICE_ID: string;
		LINE_PUSH_USER_IDS: string;
