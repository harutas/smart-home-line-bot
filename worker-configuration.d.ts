/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bc4e153aff63af73a8b35bf50a5e78bf)
...
declare namespace NodeJS {
	interface ProcessEnv
		extends StringifyValues<
			Pick<
				Cloudflare.Env,
				'LINE_CHANNEL_ACCESS_TOKEN' | 'LINE_CHANNEL_SECRET' | 'SWITCHBOT_TOKEN' | 'SWITCHBOT_SECRET' | 'ALLOWED_LINE_USER_IDS'
			>
		> {}
}
